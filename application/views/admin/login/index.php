...
<body class="nobg loginPage" style="min-height:100%;">
	<div class="loginWrapper" style="top:45%;">
		...
		<div class="widget" id="admin_login" style="height:auto; margin:auto;">
			<div class="title"><img src="<?php echo base_url(); ?>public/admin/images/icons/dark/laptop.png" alt="" class="titleIcon">
				<h6>Đăng nhập</h6>
			</div>
			...
			<form class="form" id="form" action="" method="post">
				<fieldset>
					...
					<div class="loginControl">
						<div style="color: red; font-style: italic;text-align: center;padding: 20px;">
