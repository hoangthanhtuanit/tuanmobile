...
<title>Trang web quản trị admin</title>

<meta name="robots" content="noindex, nofollow" />

<link rel="shortcut icon" href="<?php echo base_url(); ?>public/admin/images/IMG_1459.jpg" type="image/x-icon"/>
...
<script type="text/javascript" src="<?php echo base_url(); ?>public/custom_admin.js" type="text/javascript"></script>