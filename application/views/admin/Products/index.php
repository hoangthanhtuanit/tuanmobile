                            ...
                            <table width="80%" cellspacing="0" cellpadding="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="item" style="width:155px;"><input name="tensp" value="<?php echo $this->input->get('tensp') ?>" id="filter_iname" type="text" style="width:155px;"></td>
            ...
            <tbody class="list_item">
                ...
                <tr class="row_9">
                    ...
                    <td class="option textC">
                        ...
                        <a href="<?php echo admin_url('Products/del/'.$row->id)?>" title="Xóa" class="tipS verify_action">
