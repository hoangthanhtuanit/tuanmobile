            ...
            <fieldset>
                <div class="formRow">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input type="text" _autocheck="true" id="param_name" name="danhmuc"></span>
                                <span class="autocheck" name="name_autocheck"></span>
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input type="text" _autocheck="true" id="param_name" name="gpu"></span>
                                <span class="autocheck" name="name_autocheck"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input type="text" _autocheck="true" id="param_name" name="camera"></span>
                                <span class="autocheck" name="name_autocheck"></span>
