        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="option">
                        <a href="<?php echo admin_url('thanhvien/edit/'.$row->id )?>" title="Chỉnh sửa" class="tipS ">
                            <img src="<?php echo base_url(); ?>public/admin/images/icons/color/edit.png" />
                        </a>
                        <a href="<?php echo admin_url('thanhvien/delete/'.$row->id )?>" title="Xóa" class="tipS verify_action" >
