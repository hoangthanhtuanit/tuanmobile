    ...
    <div class="widget">
        ...
        <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
            <fieldset>
                ...
                <div class="formRow">
                    <label for="param_diachi" class="formLeft">Địa chỉ:<span class="req">*</span></label>
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_phone" value="<?php echo set_value('diachi') ?>" name="diachi"></span>
                        <span class="autocheck" name="name_autocheck"></span>
