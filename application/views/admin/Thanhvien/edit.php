        ...
        <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
            <fieldset>
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_name" value="<?php echo $info->fullname?>" name="fullname"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_sdt" value="<?php echo $info->phone?>" name="phone"></span>
                        <span class="autocheck" name="name_autocheck"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_sdt" value="<?php echo $info->diachi?>" name="diachi"></span>
                        <span class="autocheck" name="name_autocheck"></span>
